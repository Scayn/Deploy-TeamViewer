<#
.SYNOPSIS
    This script performs the installation or uninstallation of TeamViewer.
    # LICENSE #
...
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Install" -DeployMode "NonInteractive"
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Install" -DeployMode "Silent"
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Install" -DeployMode "Interactive"
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Uninstall" -DeployMode "NonInteractive"
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Uninstall" -DeployMode "Silent"
.EXAMPLE
    PowerShell.exe .\Deploy-TeamViewer.ps1 -DeploymentType "Uninstall" -DeployMode "Interactive"
.NOTES
...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        ## Remove Any Existing Versions of TeamViewer
